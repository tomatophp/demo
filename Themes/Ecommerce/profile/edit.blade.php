@extends('themes::layouts.profile', ['withoutCard' => true])
        ...
        <div class="flex flex-col gap-6">
            <div class="dark:bg-gray-800 p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl" dusk="update-profile-information">
                    @include('themes::profile.partials.update-profile-information-form')
                </div>
            </div>

            <div class="dark:bg-gray-800 p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl" dusk="update-password">
                    @include('themes::profile.partials.update-password-form')
                </div>
            </div>

            <div class="dark:bg-gray-800 p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl" dusk="delete-user">
                    @include('themes::profile.partials.delete-user-form')
                </div>
            </div>
        </div>
    </div>
