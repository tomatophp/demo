...
class ProfileAddressController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('themes::profile.address.index', compact('table'));
    }
    ...
    {
        return view('themes::profile.address.create');
    }
    ...
    {
        return view('themes::profile.address.show', compact('address'));
    }
    ...
    {
        return view('themes::profile.address.edit', compact('address'));
    }
