...
@section('body')
    <div class="w-full">
        ...
        <div class="border dark:border-zinc-700 rounded-lg p-4 mb-4">
            ...
            <div>
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4 border-b dark:border-zinc-700 py-4 my-4 font-bold">
                ...
                <div class="flex flex-col gap-4">
                    @foreach($order->ordersItems as $item)
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-4 border-b dark:border-zinc-700 py-4">
                            <div class="col-span-1 md:col-span-4 flex  flex-col justify-start">
                                <div>
                                    {{ $item->product?->name }}
                                </div>
