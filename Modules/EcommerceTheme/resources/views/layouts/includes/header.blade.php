                ...
                <div class="flex items-center gap-4">
                    ...
                    <x-splade-modal name="menu" slideover>
                        <x-splade-data
                            ...
                            local-storage
                        >
                            <x-splade-form method="GET" action="{{url('shop')}}" class="block mt-12 mb-4 relative border border-zinc-500 dark:border-zinc-700 rounded-full" :default="['search' => request()->search ?? '']">
                                <label class="sr-only" for="search"> {{__('Search')}} </label>
