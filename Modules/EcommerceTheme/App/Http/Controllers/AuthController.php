...
class AuthController extends Controller
{
    ...
    public function login(){
        if(!auth('accounts')->user()){
            ...
            return view('ecommerce-theme::auth.login');
        }
    ...
    public function register(){
        return view('ecommerce-theme::auth.register');
    }
    ...
    public function otp(){
        return view('ecommerce-theme::auth.otp');
    }

    public function forget(){
        return view('ecommerce-theme::auth.forget');
    }
    ...
    public function reset(){
        if(session()->get('email')){
            return view('ecommerce-theme::auth.reset');
        }
