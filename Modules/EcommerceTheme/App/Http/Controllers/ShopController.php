...
class ShopController extends Controller
{
    public function index(Request $request){
        ...
        return view('ecommerce-theme::index', compact('products', 'categories', 'options', 'page'));
    }

    public function product($slug){
        $product = Product::where('slug',$slug)->first();
        if($product){
            return view('ecommerce-theme::shop.product', compact('product'));
        }
    ...
    public function category($slug){
        return view('ecommerce-theme::shop.category');
    }
}
