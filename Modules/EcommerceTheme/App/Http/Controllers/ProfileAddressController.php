...
class ProfileAddressController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('ecommerce-theme::profile.address.index', compact('table'));
    }
    ...
    {
        return view('ecommerce-theme::profile.address.create');
    }
    ...
    {
        return view('ecommerce-theme::profile.address.show', compact('address'));
    }
    ...
    {
        return view('ecommerce-theme::profile.address.edit', compact('address'));
    }
