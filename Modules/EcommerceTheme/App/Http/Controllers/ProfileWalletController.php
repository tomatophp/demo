...
class ProfileWalletController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('ecommerce-theme::profile.wallet.index', compact('table'));
    }
    ...
    {
        return view('ecommerce-theme::profile.wallet.charge');
    }
    ...
    {
        return view('ecommerce-theme::profile.wallet.show', compact('wallet'));
    }
